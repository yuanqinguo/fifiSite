...
if __name__ == '__main__':
    myMaterial = Material()
    accessToken = '15_b7AtndCp9AoIReYSZAjryBJS7T4_3cFIvNXcMaQZpt-CiivMJAnQ7GZt5Ne3VVW3dj_2C8XsRK74uw7we-8QxOAShju2XxEfRiS-mlw3s0FvxHrmn3cFZIRh-f4SXLiAHAEJX'#Basic().get_access_token()
